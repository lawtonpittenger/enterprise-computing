...
public class ResultSetTableModel extends AbstractTableModel 
{
   ...
   public ResultSetTableModel(String query, Connection conn, Boolean status) 
      throws SQLException, ClassNotFoundException
   {         
	   connectedToDatabase = status;
	   try {
      ...
      throws SQLException, IllegalStateException 
   {
      ...
      try {
        ...
        dataSource.setPassword(properties.getProperty("MYSQL_DB_PASSWORD")); 
           ...
           int res2 = statement.executeUpdate("update operationscount set num_queries = num_queries + 1");
           connection.close();
...
// set new database update-query string
      ...
      throws SQLException, IllegalStateException 
   {
      ...
      if (res > 0) {
    	  JOptionPane.showMessageDialog(null, "Successful Update..." + res + " rows updated.");
          Properties properties = new Properties();
          FileInputStream filein = null;
          MysqlDataSource dataSource = null;
              //read properties file
          try {
            ...
            dataSource.setPassword(properties.getProperty("MYSQL_DB_PASSWORD")); 
               ...
               Statement statement = connection.createStatement( );
               int res3 = statement.executeUpdate("update operationscount set num_updates = num_updates + 1");
               connection.close();
      }
/*
      // obtain meta data for ResultSet
