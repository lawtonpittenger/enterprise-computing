    ...
    <body>
        ...
        %>
         ...
         <section >
            ...
            <h1 style="color: #FFFF00; font-size: 45px;">Welcome to the Spring 2023 Project 4 Enterprise System
               
            
            </h1>
            <h1 style="color: #00FF00; font-size: 40px;">A Servlet/JSP-based Multi-tiered Enterprise Application Using A Tomcat Container</h1>
        </section>    
        <hr>
         <section style="height: 50vh; display: flex; flex-direction: column; align-items: center; justify-content: center;">
             <p style="color: white; font-size: 21px;">You are connected to the Project 4 Enterprise System database as a <span style="color:red;">root-level</span> user </p>
             <p style="color: white; font-size: 21px;">Please enter any valid SQL query or update command in the box below</p>
            <form action="root" method="post" id="sqlForm">    
         ...
         <section style="display: flex; flex-direction: column; align-items: center; justify-content: center;" id="results-section">
            ...
            <p style="color: white; font-size: 21px;">Database Results:</p>
            ...
            <% if(childClass.getName().equals("model.SupplierShort")) { %>
             ...
             <%}else if(childClass.getName().contains("CountClass")) { %>   
                    ...
                    <table style="margin-bottom: 50px;">
                    <tr>
                      <th style="background-color: red; color: black;">total_shipments</th>
            ...
            <table style="margin-bottom: 50px;">
             ...
             <%}else if(childClass.getName().contains("Part")){ %>
                   ...
                   <% for(model.Part p : parts){ %>
                    ...
                    <div style="background-color: green; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        
                         <% for(String s : results){ %>
                            <p style="color: black; font-size: 21px; margin: 5px;"> <%=s %> </p>    
                        <% } %>
